...
public class MediatorSGColdStartBenchmarks
{
    ...
    //   Registered       + registration, and resolve
    ...
    public int MediatorSG_Startup_DiFloor()
    {
    ...
    [Benchmark]
    public int MediatorSG_Startup_Registered()
    {
        var services = new ServiceCollection();
    ...
    [Benchmark]
    public async Task<int> MediatorSG_Startup_FirstRequest()
    {
        var services = new ServiceCollection();
        MediatorSGHelper.AddMediatorSG(services);
